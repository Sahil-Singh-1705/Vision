  ...
  return (
    <main className="bg-black text-white font-sans">
      ...
      >
        ...
        <motion.p
          className="text-gray-300 text-lg md:text-2xl max-w-2xl"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          ...
          <form ref={formRef} onSubmit={sendEmail} className="space-y-6 text-left">
            <div className="grid md:grid-cols-2 gap-6">
              <input type="text" name="from_name" placeholder="Your Name"
                className="bg-gray-300 p-3 rounded-xl w-full outline-red-600 focus:outline-2 text-black font-medium" required />
            ...
            <textarea rows="5" name="message" placeholder="Your Message..."
              className="bg-gray-300 p-3 rounded-xl w-full outline-red-600 focus:outline-2 resize-none text-black font-medium" required></textarea>
            <button type="submit"
